PH_REGIONS = (
    ...
    ("RI", "Ilocos (Region I)"),
    ("RII", "Cagayan Valley (Region II)"),
    ("RIII", "Central Luzon (Region III)"),
    ("RIVA", "Calabarzon (Region IV-A)"),
    ("RIVB", "Mimaropa (Region IV-B)"),
    ("RIX", "Zamboanga Peninsula (Region IX)"),
    ("RV", "Bicol (Region V)"),
    ("RVI", "Western Visayas (Region VI)"),
    ("RVII", "Central Visayas (Region VII)"),
    ("RVIII", "Eastern Visayas (Region VIII)"),
    ("RX", "Northern Mindanao (Region X)"),
    ("RXI", "Davao (Region XI)"),
    ("RXII", "Soccsksargen (Region XII)"),
    ("RXIII", "Caraga (Region XIII)"),
    ("RXVIII", "Negros Island Region "),
)
...
PH_ZIP_CODES = (
    ...
    ("5707", "Tibiao Antique"),
    ("5716", "Tobias Fornier Antique"),
    ("5703", "Valderrama Antique"),
    ("3814", "Calanasan Apayao"),
    ("3807", "Conner Apayao"),
    ("3810", "Flora Apayao"),
    ("3809", "Kabugao Apayao"),
    ("3813", "Luna Apayao"),
    ...
    ("7307", "Akbar Basilan"),
    ("7308", "Al-Barka Basilan"),
    ("7309", "Hadji Mohammad Ajul Basilan"),
    ("7310", "Ungkaya Pukan Basilan"),
    ("7311", "Hadji Muhtamad Basilan"),
    ("7312", "Tabuan-Lasa Basilan"),
    ("2114", "Abucay Bataan"),
    ("2107", "Bagac Bataan"),
    ("2100", "Balanga Bataan"),
    ("2106", "Bataan Export Processing Zone Bataan"),
    ...
    ("2102", "Orion Bataan"),
    ("2101", "Pilar Bataan"),
    ("2109", "Philippine Refugee Processing Center B"),
    ("2113", "Samal Bataan"),
    ("3900", "Basco Batanes"),
    ...
    ("2602", "Philippine Military Academy Benguet"),
    ("2614", "Sablan Benguet"),
    ("2603", "Tuba Benguet"),
    ("2615", "Tublay Benguet"),
    ...
    ("4125", "Corregidor Island Cavite"),
    ("4114", "Dasmarinas Cavite"),
    ("4115", "Dasmarinas Resettlement Area Cavite"),
    ("4126", "First Cavite Industrial Estate Cavite"),
    ("4124", "General Emilio Aguinaldo Cavite"),
    ...
    ("4108", "Tanza Cavite"),
    ("4111", "Ternate Cavite"),
    ("4109", "Trece Martires City Cavite"),
    ("6033", "Alcantara Cebu"),
    ("6023", "Alcoy Cebu"),
    ("6030", "Alegria Cebu"),
    ...
    ("8800", "Nabunturan Compostela Valley"),
    ...
    ("8119", "Samal City Davao del Norte"),
    ...
    ("4033", "Bay Laguna"),
    ("4024", "Binan City Laguna"),
    ("4006", "Magdalena Laguna"),
    ("4025", "Cabuyao City Laguna"),
    ...
    ("4010", "Pila Laguna"),
    ("4003", "Rizal Laguna"),
    ("4000", "San Pablo City Laguna"),
    ("4023", "San Pedro City Laguna"),
    ("4009", "Santa Cruz Laguna"),
    ("4022", "Santa Maria Laguna"),
    ("4026", "Santa Rosa City Laguna"),
    ("4019", "Siniloan Laguna"),
    ("4031", "University of the Philippines Laguna"),
    ...
    ("9215", "Sultan Naga Dimaporo (Karomatan) Lanao"),
    ...
    ("9308", "Lumbaca-Unayan and Macadar Andong Lana"),
    ...
    ("9606", "Kabuntalan and Northern Kabuntalan Mag"),
    ...
    ("9605", "Sultan Kudarat and Sultan Mastura Magu"),
    ("9611", "Sultan sa Barongis Maguindanao"),
    ("9612", "Talayan Maguindanao"),
    ("9602", "Upi andDatu Blah T. Sinsuat Maguindana"),
    ...
    ("5402", "Uson Masbate"),
    ("1420", "Caloocan (Kaybiga / Deparo) Metro Mani"),
    ("1421", "Caloocan (Bagumbong / Pag-asa) Metro M"),
    ("1422", "Caloocan (Novaliches North) Metro Mani"),
    ("1423", "Caloocan (Lilles Ville Subdivision) Me"),
    ("1424", "Caloocan (Captol Parkland Subdivision)"),
    ("1425", "Caloocan (Amparo Subdivision / Dela Co"),
    ("1426", "Caloocan (Bankers Village) Metro Manil"),
    ("1427", "Caloocan (Tala Leprosarium and Victory"),
    ("1428", "Caloocan (Bagong Silang) Metro Manila"),
    ("1400", "Caloocan (Caloocan City Central Post O"),
    ("1401", "Caloocan (Baesa) Metro Manila"),
    ("1402", "Caloocan (Santa Quiteria) Metro Manila"),
    ("1403", "Caloocan (Grace Park East) Metro Manil"),
    ("1404", "Caloocan (San Jose) Metro Manila"),
    ("1405", "Caloocan (First Avenue to Seventh Aven"),
    ("1406", "Caloocan (Grace Park West) Metro Manil"),
    ("1407", "Caloocan (University Hills) Metro Mani"),
    ("1408", "Caloocan (Sangandaan) Metro Manila"),
    ("1409", "Caloocan (Kaunlaran Village (shared wi"),
    ("1410", "Caloocan (Maypajo) Metro Manila"),
    ("1411", "Caloocan (Fish Market (shared with Nav"),
    ("1412", "Caloocan (Isla de Cocomo) Metro Manila"),
    ("1413", "Caloocan (Kapitbayahan) Metro Manila"),
    ("1740", "Las Pinas (Las Pinas Central Post Offi"),
    ("1741", "Las Pinas (Remarville Subdivision) Met"),
    ("1742", "Las Pinas (Pulang Lupa and Zapote) Met"),
    ("1743", "Las Pinas (Cut-cut) Metro Manila"),
    ("1744", "Las Pinas (Manuyo) Metro Manila"),
    ("1745", "Las Pinas (Gatchalian Subdivision) Met"),
    ("1746", "Las Pinas (Verdant Acres Subdivision) "),
    ("1747", "Las Pinas (Moonwalk Subdivision and Ta"),
    ("1748", "Las Pinas (Manila Doctors Village) Met"),
    ("1749", "Las Pinas (Angela Village) Metro Manil"),
    ("1750", "Las Pinas (Almanza) Metro Manila"),
    ("1751", "Las Pinas (T.S. Cruz Subdivision) Metr"),
    ("1752", "Las Pinas (Soldiers Hills Subdivision)"),
    ("1200", "Makati (Makati Central Post Office) Me"),
    ("1201", "Makati (Fort Bonifacio) Metro Manila"),
    ("1202", "Makati (Fort Bonifacio Naval Station) "),
    ("1203", "Makati (San Antonio Village) Metro Man"),
    ("1204", "Makati (La Paz-Singkamas-Tejeros)"),
    ("1205", "Makati (Santa Cruz) Metro Manila"),
    ("1206", "Makati (Kasilawan) Metro Manila"),
    ("1207", "Makati (Carmona and Olympia) Metro Man"),
    ("1208", "Makati (Valenzuela (includes Rizal) Me"),
    ("1209", "Makati (Bel-Air) Metro Manila"),
    ("1210", "Makati (Poblacion) Metro Manila"),
    ("1211", "Makati (Guadalupe Viejo) Metro Manila"),
    ("1212", "Makati (Guadalupe Nuevo) Metro Manila"),
    ("1213", "Makati (Pinagkaisahan - Pitogo) Metro "),
    ("1214", "Makati (Cembo) Metro Manila"),
    ("1215", "Makati (West Rembo) Metro Manila"),
    ("1216", "Makati (East Rembo and Malapad na Bato"),
    ("1217", "Makati (Comembo) Metro Manila"),
    ("1218", "Makati (Pembo) Metro Manila"),
    ("1219", "Makati (Forbes Park North) Metro Manil"),
    ("1220", "Makati (Forbes Park South) Metro Manil"),
    ("1221", "Makati (Dasmarinas Village North) Metr"),
    ("1222", "Makati (Dasmarinas Village South) Metr"),
    ("1223", "Makati (San Lorenzo Village) Metro Man"),
    ("1224", "Makati (Makati Commercial Center) Metr"),
    ("1225", "Makati (Urdaneta Village) Metro Manila"),
    ("1226", "Makati (Ayala Avenue-Paseo de Roxas) M"),
    ("1227", "Makati (Salcedo Village) Metro Manila"),
    ("1228", "Makati (Greenbelt) Metro Manila"),
    ("1229", "Makati (Legaspi Village) Metro Manila"),
    ("1230", "Makati (Pio del Pilar) Metro Manila"),
    ("1231", "Makati (Pasong Tamo and Ecology Villag"),
    ("1232", "Makati (Magallanes Village) Metro Mani"),
    ("1233", "Makati (Bangkal) Metro Manila"),
    ("1234", "Makati (San Isidro) Metro Manila"),
    ("1235", "Makati (Palanan) Metro Manila"),
    ("1470", "Malabon (Malabon) Metro Manila"),
    ("1471", "Malabon (Catmon) Metro Manila"),
    ("1472", "Malabon (Longos) Metro Manila"),
    ("1473", "Malabon (Tonsuya) Metro Manila"),
    ("1474", "Malabon (Acacia) Metro Manila"),
    ("1475", "Malabon (Potrero) Metro Manila"),
    ("1476", "Malabon (Araneta Subdivision) Metro Ma"),
    ("1477", "Malabon (Maysilo) Metro Manila"),
    ("1478", "Malabon (Santolan) Metro Manila"),
    ("1479", "Malabon (Muzon) Metro Manila"),
    ("1480", "Malabon (Dampalit) Metro Manila"),
    ("1470", "Malabon (Tinajeros) Metro Manila"),
    ("1480", "Malabon (UFO) Metro Manila"),
    ("1481", "Malabon (NCR) Metro Manila"),
    ("1550", "Mandaluyong (Mandaluyong Central Post "),
    ("1551", "Mandaluyong (Vergara) Metro Manila"),
    ("1552", "Mandaluyong (Shaw Boulevard) Metro Man"),
    ("1553", "Mandaluyong (National Center for Menta"),
    ("1554", "Mandaluyong (East EDSA) Metro Manila"),
    ("1555", "Mandaluyong (Wack Wack) Metro Manila"),
    ("1556", "Mandaluyong (Greenhills South) Metro M"),
    ("1550", "Mandaluyong (Barangay Plainview) Metro"),
    ("1000", "Manila (Manila Central Post Office) Me"),
    ("1001", "Manila (Quiapo) Metro Manila"),
    ("1002", "Manila (Intramuros) Metro Manila"),
    ("1003", "Manila (Santa Cruz) Metro Manila"),
    ("1004", "Manila (Malate) Metro Manila"),
    ("1005", "Manila (San Miguel) Metro Manila"),
    ("1006", "Manila (Binondo) Metro Manila"),
    ("1007", "Manila (Paco) Metro Manila"),
    ("1008", "Manila (Sampaloc) Metro Manila"),
    ("1009", "Manila (Santa Ana) Metro Manila"),
    ("1010", "Manila (San Nicolas) Metro Manila"),
    ("1011", "Manila (Pandacan) Metro Manila"),
    ("1012", "Manila (Tondo) Metro Manila"),
    ("1013", "Manila (Tondo) Metro Manila"),
    ("1014", "Manila (Santa Cruz) Metro Manila"),
    ("1015", "Manila (Sampaloc) Metro Manila"),
    ("1016", "Manila (Santa Mesa) Metro Manila"),
    ("1017", "Manila (San Andres) Metro Manila"),
    ("1018", "Manila (Port Area) Metro Manila"),
    ("1800", "Marikina (Marikina Central Post Office"),
    ("1801", "Marikina (San Roque-Calumpang) Metro M"),
    ("1802", "Marikina (Industrial Valley) Metro Man"),
    ("1803", "Marikina (Barangka and Tanong) Metro M"),
    ("1804", "Marikina (J. De La Pena) Metro Manila"),
    ("1805", "Marikina (Malanday) Metro Manila"),
    ("1806", "Marikina (Northern and WesternMarikina"),
    ("1807", "Marikina (Concepcion 1) Metro Manila"),
    ("1808", "Marikina (Nangka) Metro Manila"),
    ("1809", "Marikina (Parang) Metro Manila"),
    ("1810", "Marikina (Marikina Heights) Metro Mani"),
    ("1811", "Marikina (Concepcion 2) Metro Manila"),
    ("1820", "Marikina (Bagong Nayon"),
    ("1770", "Muntinlupa (Muntinlupa Central Post Of"),
    ("1771", "Muntinlupa (Buli / Cupang) Metro Manil"),
    ("1772", "Muntinlupa (Bayanan / Putatan) Metro M"),
    ("1773", "Muntinlupa (Tunasan) Metro Manila"),
    ("1776", "Muntinlupa (Poblacion) Metro Manila"),
    ("1780", "Muntinlupa (Ayala Alabang) Metro Manil"),
    ("1781", "Muntinlupa (Filinvest City) Metro Mani"),
    ("1411", "Navotas (Fish Market) Metro Manila"),
    ("1412", "Navotas (Isla de Cocomo) Metro Manila"),
    ("1413", "Navotas (Kapitbahayan East) Metro Mani"),
    ("1409", "Navotas (Kaunlaran Village) Metro Mani"),
    ("1485", "Navotas (Navotas) Metro Manila"),
    ("1489", "Navotas (Tangos) Metro Manila"),
    ("1490", "Navotas (Tanza) Metro Manila"),
    ("1778", "Paranaque (Aeropark Subdivision) Metro"),
    ("1702", "Paranaque (Baclaran) Metro Manila"),
    ("1711", "Paranaque (Better Living Subdivision) "),
    ("1720", "Paranaque (BF Homes 1) Metro Manila"),
    ("1718", "Paranaque (BF Homes 2) Metro Manila"),
    ("1710", "Paranaque (Executive Heights Subdivisi"),
    ("1719", "Paranaque (Ireneville Subdivision I & "),
    ("1714", "Paranaque (Ireneville Subdivision II) "),
    ("1700", "Paranaque (Don Galo) Metro Manila"),
    ("1717", "Paranaque (Manila Memorial Park) Metro"),
    ("1703", "Paranaque (Marina Subdivision (Reclama"),
    ("1719", "Paranaque (Maywood Village I) Metro Ma"),
    ("1716", "Paranaque (Maywood Village II) Metro M"),
    ("1700", "Paranaque (Mon-El Subdivision) Metro M"),
    ("1712", "Paranaque (Miramar Subdivision) Metro "),
    ("1708", "Paranaque (Multinational Village) Metr"),
    ("1705", "Paranaque (Ninoy Aquino International "),
    ("1700", "Paranaque (Paranaque CPO) Metro Manila"),
    ("1706", "Paranaque (Pulo) Metro Manila"),
    ("1715", "Paranaque (San Antonio Valley 1) Metro"),
    ("1707", "Paranaque (San Antonio Valley 11 & 12)"),
    ("1704", "Paranaque (Santo Nino) Metro Manila"),
    ("1709", "Paranaque (South Admiral Village"),
    ("1701", "Paranaque (Tambo) Metro Manila"),
    ("1713", "Paranaque (United Paranaque Subdivisio"),
    ("1300", "Pasay (Pasay City Central Post Office)"),
    ("1301", "Pasay (Domestic Airport P.O.) Metro Ma"),
    ("1302", "Pasay (San Rafael) Metro Manila"),
    ("1303", "Pasay (San Roque) Metro Manila"),
    ("1304", "Pasay (Santa Clara) Metro Manila"),
    ("1305", "Pasay (San Jose) Metro Manila"),
    ("1306", "Pasay (San Isidro) Metro Manila"),
    ("1307", "Pasay (Philippine International Conven"),
    ("1308", "Pasay (Bay City) Metro Manila"),
    ("1309", "Pasay (Villamor Airbase) Metro Manila"),
    ("1600", "Pasig (Pasig Central Post Office) Metr"),
    ("1601", "Pasig (San Joaquin) Metro Manila"),
    ("1602", "Pasig (Pinagbuhatan) Metro Manila"),
    ("1603", "Pasig (Kapitolyo) Metro Manila"),
    ("1604", "Pasig (Ugong) Metro Manila"),
    ("1605", "Pasig (Ortigas Post Office) Metro Mani"),
    ("1606", "Pasig (Caniogan) Metro Manila"),
    ("1607", "Pasig (Maybunga) Metro Manila"),
    ("1608", "Pasig (Santa Lucia) Metro Manila"),
    ("1609", "Pasig (Rosario) Metro Manila"),
    ("1610", "Pasig (Santolan) Metro Manila"),
    ("1611", "Pasig (Manggahan) Metro Manila"),
    ("1612", "Pasig (Green Park) Metro Manila"),
    ("1620", "Pateros (Aguhos) Metro Manila"),
    ("1621", "Pateros (Santa Ana) Metro Manila"),
    ("1622", "Pateros (San Roque) Metro Manila"),
    ("1623", "Pateros (San Pedro) Metro Manila"),
    ("1105", "Quezon City (Alicia) Metro Manila"),
    ("1102", "Quezon City (Amihan) Metro Manila"),
    ("1106", "Quezon City (Apolonio Samson) Metro Ma"),
    ("810", "Quezon City (Araneta Center) Metro Mani"),
    ("1135", "Quezon City (Araneta Center P.O. Boxes"),
    ("1106", "Quezon City (Baesa) Metro Manila"),
    ("1116", "Quezon City (Bagbag) Metro Manila"),
    ("1110", "Quezon City (Bagong Bayan) Metro Manil"),
    ("1109", "Quezon City (Bagumbuhay) Metro Manila"),
    ("1111", "Quezon City (Bagong Lipunan) Metro Man"),
    ("1105", "Quezon City (Bagong Pag-Asa) Metro Man"),
    ("1119", "Quezon City (Bagong Silangan) Metro Ma"),
    ("1106", "Quezon City (Bahay Toro) Metro Manila"),
    ("1115", "Quezon City (Balingasa) Metro Manila"),
    ("1106", "Quezon City (Balintawak) Metro Manila"),
    ("1106", "Quezon City (Balumbato) Metro Manila"),
    ("1126", "Quezon City (Batasan Hills) Metro Mani"),
    ("1109", "Quezon City (Bayanihan) Metro Manila"),
    ("1120", "Quezon City (BF Homes) Metro Manila"),
    ("1109", "Quezon City (Blue Ridge) Metro Manila"),
    ("1101", "Quezon City (Botocan) Metro Manila"),
    ("1141", "Quezon City (Broadway Center P.O. Boxe"),
    ("1105", "Quezon City (Bungad) Metro Manila"),
    ("820", "Quezon City (Bureau of Internal Revenue"),
    ("1110", "Quezon City (Camp Aguinaldo) Metro Man"),
    ("802", "Quezon City (Camp Aguinaldo) Metro Mani"),
    ("801", "Quezon City (Camp Crame) Metro Manila"),
    ("1126", "Quezon City (Capitol Hills/Park) Metro"),
    ("1117", "Quezon City (Capri) Metro Manila"),
    ("1100", "Quezon City (Central) Metro Manila"),
    ("1102", "Quezon City (Claro) Metro Manila"),
    ("880", "Quezon City (Commission on Audit) Metro"),
    ("1121", "Quezon City (Commonwealth) Metro Manil"),
    ("1111", "Quezon City (Crame) Metro Manila"),
    ("1109", "Quezon City (Cubao) Metro Manila"),
    ("1128", "Quezon City (Culiat) Metro Manila"),
    ("1115", "Quezon City (Damar) Metro Manila"),
    ("1104", "Quezon City (Damayan) Metro Manila"),
    ("1112", "Quezon City (Damayan Lagi) Metro Manil"),
    ("1123", "Quezon City (Damong Maliit) Metro Mani"),
    ("1105", "Quezon City (Del Monte) Metro Manila"),
    ("1104", "Quezon City (Diliman) Metro Manila"),
    ("1109", "Quezon City (Dioquino Zobel) Metro Man"),
    ("1113", "Quezon City (Don Manuel) Metro Manila"),
    ("1113", "Quezon City (Dona Aurora) Metro Manila"),
    ("1125", "Quezon City (Dona Faustina Subdivision"),
    ("1113", "Quezon City (Dona Imelda) Metro Manila"),
    ("1113", "Quezon City (Dona Josefa) Metro Manila"),
    ("1102", "Quezon City (Duyan-Duyan) Metro Manila"),
    ("1102", "Quezon City (E. Rodriguez) Metro Manil"),
    ("1109", "Quezon City (Escopa) Metro Manila"),
    ("1118", "Quezon City (Fairview) Metro Manila"),
    ("1121", "Quezon City (Fairview [North]) Metro M"),
    ("1122", "Quezon City (Fairview [South]) Metro M"),
    ("1114", "Quezon City (Gintong Silahis) Metro Ma"),
    ("1117", "Quezon City (Gulod) Metro Manila"),
    ("1127", "Quezon City (Holy Spirit) Metro Manila"),
    ("1112", "Quezon City (Horseshoe) Metro Manila"),
    ("1111", "Quezon City (Immaculate Concepcion) Me"),
    ("1124", "Quezon City (Kaligayahan) Metro Manila"),
    ("1112", "Quezon City (Kalusugan) Metro Manila"),
    ("1102", "Quezon City (Kamias) Metro Manila"),
    ("1103", "Quezon City (Kamuning) Metro Manila"),
    ("1105", "Quezon City (Katipunan) Metro Manila"),
    ("1111", "Quezon City (Kaunlaran) Metro Manila"),
    ("1112", "Quezon City (Kristong Hari) Metro Mani"),
    ("1101", "Quezon City (Krus na Ligas) Metro Mani"),
    ("1114", "Quezon City (La Loma) Metro Manila"),
    ("1103", "Quezon City (Laging Handa) Metro Manil"),
    ("1110", "Quezon City (Libis) Metro Manila"),
    ("1114", "Quezon City (Lourdes) Metro Manila"),
    ("1108", "Quezon City (Loyola Heights) Metro Man"),
    ("1114", "Quezon City (Maharlika) Metro Manila"),
    ("1101", "Quezon City (Malaya) Metro Manila"),
    ("1109", "Quezon City (Mangga) Metro Manila"),
    ("1115", "Quezon City (Manresa) Metro Manila"),
    ("1112", "Quezon City (Mariana) Metro Manila"),
    ("1104", "Quezon City (Mariblo) Metro Manila"),
    ("1109", "Quezon City (Marilag) Metro Manila"),
    ("1109", "Quezon City (Masagana) Metro Manila"),
    ("1115", "Quezon City (Masambong) Metro Manila"),
    ("1114", "Quezon City (Matalahib) Metro Manila"),
    ("1119", "Quezon City (Matandang Balara) Metro M"),
    ("1109", "Quezon City (Milagrosa) Metro Manila"),
    ("1138", "Quezon City (Murphy District P.O. Boxe"),
    ("1125", "Quezon City (Nagkaisang Nayon) Metro M"),
    ("830", "Quezon City (National Irrigation Admini"),
    ("1104", "Quezon City (Nayon Kaunlaran) Metro Ma"),
    ("1107", "Quezon City (New Era) Metro Manila"),
    ("1147", "Quezon City (Novaliches P.O. Boxes) Me"),
    ("1123", "Quezon City (Novaliches Proper) Metro "),
    ("1103", "Quezon City (Obrero) Metro Manila"),
    ("1101", "Quezon City (Old Capitol Site) Metro M"),
    ("1114", "Quezon City (Paang Bundok) Metro Manil"),
    ("1115", "Quezon City (Pag-Ibig sa Nayon) Metro "),
    ("1103", "Quezon City (Paligsahan) Metro Manila"),
    ("1105", "Quezon City (Paltok) Metro Manila"),
    ("1108", "Quezon City (Pansol) Metro Manila"),
    ("1104", "Quezon City (Paraiso) Metro Manila"),
    ("1118", "Quezon City (Pasong Putik) Metro Manil"),
    ("1107", "Quezon City (Pasong Tamo) Metro Manila"),
    ("1119", "Quezon City (Payatas) Metro Manila"),
    ("1104", "Quezon City (Phil-Am) Metro Manila"),
    ("850", "Quezon City (Philippine Heart Center) M"),
    ("1111", "Quezon City (Pinagkaisahan) Metro Mani"),
    ("1100", "Quezon City (Pinahan) Metro Manila"),
    ("1109", "Quezon City (Project 4) Metro Manila"),
    ("1100", "Quezon City (Project 6) Metro Manila"),
    ("1105", "Quezon City (Project 7) Metro Manila"),
    ("1106", "Quezon City (Project 8) Metro Manila"),
    ("1100", "Quezon City (Quezon City CPO) Metro Ma"),
    ("860", "Quezon City (Quezon City Hall) Metro Ma"),
    ("1102", "Quezon City (Quirino District (Project"),
    ("1105", "Quezon City (R. Magsaysay) Metro Manil"),
    ("1103", "Quezon City (Roxas District) Metro Man"),
    ("1103", "Quezon City (Sacred Heart) Metro Manil"),
    ("1114", "Quezon City (Salvacion) Metro Manila"),
    ("1117", "Quezon City (San Agustin) Metro Manila"),
    ("1105", "Quezon City (San Antonio"),
    ("1116", "Quezon City (San Bartolome) Metro Mani"),
    ("1113", "Quezon City (San Isidro) Metro Manila"),
    ("1114", "Quezon City (San Isidro Labrador) Metr"),
    ("1115", "Quezon City (San Jose) Metro Manila"),
    ("1109", "Quezon City (San Roque) Metro Manila"),
    ("1101", "Quezon City (San Vicente) Metro Manila"),
    ("1116", "Quezon City (Sangandaan (GSIS Village)"),
    ("1104", "Quezon City (Santa Cruz) Metro Manila"),
    ("1117", "Quezon City (Santa Lucia) Metro Manila"),
    ("1117", "Quezon City (Santa Monica) Metro Manil"),
    ("1114", "Quezon City (Santa Teresita) Metro Man"),
    ("1105", "Quezon City (Santo Cristo) Metro Manil"),
    ("1113", "Quezon City (Santo Nino) Metro Manila"),
    ("1113", "Quezon City (Santol) Metro Manila"),
    ("1116", "Quezon City (Sauyo) Metro Manila"),
    ("1114", "Quezon City (Sienna) Metro Manila"),
    ("1101", "Quezon City (Sikatuna Village) Metro M"),
    ("1102", "Quezon City (Silangan) Metro Manila"),
    ("800", "Quezon City (Social Security System) Me"),
    ("1109", "Quezon City (Socorro) Metro Manila"),
    ("1103", "Quezon City (South Triangle) Metro Man"),
    ("1110", "Quezon City (St. Ignatius) Metro Manil"),
    ("1111", "Quezon City (St. Martin de Porres) Met"),
    ("1114", "Quezon City (St. Peter) Metro Manila"),
    ("1109", "Quezon City (Tagumpay) Metro Manila"),
    ("1110", "Quezon City (Talampas) Metro Manila"),
    ("1104", "Quezon City (Talayan) Metro Manila"),
    ("1116", "Quezon City (Talipapa) Metro Manila"),
    ("1116", "Quezon City (Tandang Sora) Metro Manil"),
    ("1113", "Quezon City (Tatalon) Metro Manila"),
    ("1101", "Quezon City (Teachers Village) Metro M"),
    ("1110", "Quezon City (Ugong Norte) Metro Manila"),
    ("1106", "Quezon City (Unang Sigaw) Metro Manila"),
    ("1101", "Quezon City (University of the Philipp"),
    ("1144", "Quezon City (University of the Philipp"),
    ("1101", "Quezon City (University of the Philipp"),
    ("840", "Quezon City (V. Luna Hospital) Metro Ma"),
    ("1112", "Quezon City (Valencia) Metro Manila"),
    ("1128", "Quezon City (Vasra) Metro Manila"),
    ("870", "Quezon City (Veterans Hospital) Metro M"),
    ("1105", "Quezon City (Veterans Village) Metro M"),
    ("1109", "Quezon City (Villa Maria Clara) Metro "),
    ("1120", "Quezon City (Violago Homes) Metro Mani"),
    ("1104", "Quezon City (West Triangle) Metro Mani"),
    ("1110", "Quezon City (White Plains) Metro Manil"),
    ("1500", "San Juan (San Juan Central Post Office"),
    ("1502", "San Juan (Greenhills Post Office) Metr"),
    ("1503", "San Juan (Greenhills [North]) Metro Ma"),
    ("1504", "San Juan (Eisenhower - Crame) Metro Ma"),
    ("400", "San Juan (International Correspondence "),
    ("401", "San Juan (Asian Development Bank) Metro"),
    ("410", "San Juan (Radio Bible Class) Metro Mani"),
    ("420", "San Juan (Bible School on the Air) Metr"),
    ("1630", "Taguig (Bagumbayan and Pinagsama) Metr"),
    ("1636", "Taguig (Bay Breeze Executive Village) "),
    ("1631", "Taguig (Bicutan) Metro Manila"),
    ("1632", "Taguig (Lower Bicutan - Ususan) Metro "),
    ("1633", "Taguig (Upper Bicutan) Metro Manila"),
    ("1630", "Taguig (Western Bicutan) Metro Manila"),
    ("1638", "Taguig (Ligid) Metro Manila"),
    ("1634", "Taguig (Nichols - McKinley - Fort Boni"),
    ("1638", "Taguig (Tuktukan) Metro Manila"),
    ("1637", "Taguig (Ibayo) Metro Manila"),
    ("1444", "Valenzuela (Arkong Bato) Metro Manila"),
    ("1445", "Valenzuela (Balangkas) Metro Manila"),
    ("1443", "Valenzuela (Dalandanan - West Canumay)"),
    ("1447", "Valenzuela (East Canumay - Lawang Bato"),
    ("1442", "Valenzuela (Fortune Village) Metro Man"),
    ("1442", "Valenzuela (General T. de Leon) Metro "),
    ("1441", "Valenzuela (Karuhatan - Parada) Metro "),
    ("1446", "Valenzuela (Lingunan) Metro Manila"),
    ("1444", "Valenzuela (Mabolo) Metro Manila"),
    ("1444", "Valenzuela (Malanday) Metro Manila"),
    ("1448", "Valenzuela (Mapulang Lupa) Metro Manil"),
    ("1442", "Valenzuela (Paso de Blas) Metro Manila"),
    ("1444", "Valenzuela (Pasolo) Metro Manila"),
    ("1444", "Valenzuela (Polo) Metro Manila"),
    ("1444", "Valenzuela (Rincon) Metro Manila"),
    ("1440", "Valenzuela (Valenzuela Central Post Of"),
    ("1496", "Valenzuela (Valenzuela P.O. Boxes) Met"),
    ...
    ("6124", "Escalante City Negros Occidental"),
    ...
    ("6224", "VallVallehermoso Negros Oriental"),
    ...
    ("3123", "Carranglan Nueva Ecija"),
    ("3120", "Central Luzon State University Nueva E"),
    ...
    ("3119", "Science City of Munoz Nueva Ecija"),
    ...
    ("5301", "Iwahig Prison and Penal Farm Palawan"),
    ("5302", "Aborlan Palawan"),
    ("5303", "Narra (Panacan) Palawan"),
    ("5304", "Quezon Palawan"),
    ("5305", "Brookes Point Palawan"),
    ...
    ("9811", "Sen. Ninoy Aquino Sultan Kudarat"),
    ("9800", "Tacurong Sultan Kudarat"),
    ("7407", "Indanan Sulu"),
    ("7400", "Jolo Sulu"),
    ("7416", "Kalingalan Caluang Sulu"),
    ("7411", "Lugus Sulu"),
    ("7404", "Luuk Sulu"),
    ("7409", "Maimbung Sulu"),
    ("7413", "Hadji Panglima Tahil Sulu"),
    ("7402", "Old Panamao Sulu"),
    ("7415", "Panglima Estino Sulu"),
    ...
    ("2210", "Palauig &Scarborough Shoal Zambales"),
    ...
    ("2209", "Subic Zambales"),
    ("2222", "Subic Bay Freeport Zone (Metro Subic) "),
    ("7112", "Leon B. Postigo Zamboanga del Norte"),
    ("7100", "Godod Zamboanga del Norte"),
    ...
    ("7111", "Jose Dalman (Ponot) Zamboanga del Nort"),
    ...
    ("7102", "Pres. Manuel A. Roxas Zamboanga del No"),
    ("7114", "Salug Zamboanga del Norte"),
    ("7108", "Sergio Osmena Sr. Zamboanga del Norte"),
    ...
    ("7024", "Ramon Magsaysay (Liargo) Zamboanga del"),
    ("7029", "San Miguel Zamboanga del Sur"),
    ("7031", "San Pablo Zamboanga del Sur"),
    ("7022", "Sominot (Don Mariano Marcos) Zamboanga"),
