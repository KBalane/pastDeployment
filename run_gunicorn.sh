...
SOCKFILE=/var/run/gunicorn/gunicorn.sock           # we will communicte using this unix socket
...
exec gunicorn ${DJANGO_WSGI_MODULE}:application -c ${DJANGODIR}gunicorn.conf.py
